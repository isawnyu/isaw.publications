...
def setup_product():
    ...
    import isaw.publications
    zcml.load_config('configure.zcml', isaw.publications)
    ...
    ztc.installPackage('isaw.publications')
...
setup_product()
ptc.setupPloneSite(products=['isaw.publications'])
